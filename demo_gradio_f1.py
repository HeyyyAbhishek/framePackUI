...
with block:
    ...
    with gr.Row():
        with gr.Column():
            ...
            with gr.Group():
                ...
                mp4_crf = gr.Slider(label="MP4 Compression", minimum=0, maximum=100,
                                    value=16, step=1,
                                    info="0 = lossless, increase to reduce file size")
    ...
    start_button.click(fn=process,
                       inputs=[input_image, prompt, n_prompt, seed, total_second_length,
                               latent_window_size, steps, cfg, gs, rs,
                               gpu_memory_preservation, use_teacache, mp4_crf],
                       outputs=[result_video, preview_image,
